...
def test_size_after_adding_movies(watchlist):
    watchlist.add_movie(Movie("Moana", 2016), datetime(2020, 9, 3))
    watchlist.add_movie(Movie("Ice Age", 2002), datetime(2020, 9, 1))
    watchlist.add_movie(Movie("Guardians of the Galaxy", 2012), datetime(2020, 9, 15))
